...
#define METALOG_DEFINE_VARIADIC_JOIN_CONJUNCTION(X, Y) \
    BOOST_PP_ASSERT(BOOST_PP_LESS_EQUAL(0, X)) \
    BOOST_PP_ASSERT(BOOST_PP_LESS_EQUAL(X, METALOG_MAX_VARIADIC_ARGS)) \
    BOOST_PP_ASSERT(BOOST_PP_LESS_EQUAL(0, Y)) \
    BOOST_PP_ASSERT(BOOST_PP_LESS_EQUAL(Y, METALOG_MAX_VARIADIC_ARGS)) \
...
#define METALOG_FORWARD_DEFINE_JOIN_CONJUNCTION(Z, Y, X) \
    METALOG_DEFINE_JOIN_CONJUNCTION(X, Y)

#define METALOG_FORWARD_FOR_EACH_JOIN_CONJUNCTION_DEFINITION(Z, X, _) \
    BOOST_PP_REPEAT_FROM_TO_ ## Z(0, BOOST_PP_SUB(BOOST_PP_ADD(METALOG_MAX_VARIADIC_ARGS, 1), X), METALOG_FORWARD_DEFINE_JOIN_CONJUNCTION, X)
...
#define METALOG_FORWARD_DEFINE_VARIADIC_JOIN_CONJUNCTION(Z, Y, X) \
    METALOG_DEFINE_VARIADIC_JOIN_CONJUNCTION(X, Y)

#define METALOG_FORWARD_FOR_EACH_VARIADIC_JOIN_CONJUNCTION_DEFINITION(Z, X, _) \
    BOOST_PP_REPEAT_FROM_TO_ ## Z(0, BOOST_PP_SUB(BOOST_PP_ADD(METALOG_MAX_VARIADIC_ARGS, 1), X), METALOG_FORWARD_DEFINE_VARIADIC_JOIN_CONJUNCTION, X)

    BOOST_PP_REPEAT_FROM_TO(0, BOOST_PP_ADD(METALOG_MAX_VARIADIC_ARGS, 1), METALOG_FORWARD_FOR_EACH_VARIADIC_JOIN_CONJUNCTION_DEFINITION, _)

#else
    METALOG_DEFINE_JOIN_CONJUNCTION(METALOG_MAX_VARIADIC_ARGS, METALOG_MAX_VARIADIC_ARGS)
    METALOG_DEFINE_VARIADIC_JOIN_CONJUNCTION(METALOG_MAX_VARIADIC_ARGS, METALOG_MAX_VARIADIC_ARGS)
#endif
}
