...
#define METALOG_FORWARD_DEFINE_JOIN_CONJUNCTION(Z, X, _) \
    METALOG_DEFINE_JOIN_CONJUNCTION(X, BOOST_PP_SUB(METALOG_MAX_VARIADIC_ARGS, X))
...
namespace metalog
{
    namespace detail
    {
        ...
        BOOST_PP_REPEAT_FROM_TO(0, BOOST_PP_ADD(METALOG_MAX_VARIADIC_ARGS, 1), METALOG_FORWARD_DEFINE_JOIN_CONJUNCTION, _)
#else
